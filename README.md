...
<p align="center">
  <img src="[https://capsule-render.vercel.app/api?type=waving&color=0d0b18,FF007F,00F0FF&height=250&section=header&text=AeroGlide&fontSize=56&fontColor=ffffff&font=Orbitron&desc=Next-Gen%20Virtual%20Gesture%20Touchpad%20for%20Windows&descColor=00f0ff&descSize=16&descAlignY=72&animation=twinkle](https://capsule-render.vercel.app/api?type=waving&height=300&color=6a11cb,ff758c&text=AeroGlide&fontColor=ffffff&fontSize=80&fontAlignY=40&animation=twinkling&desc=Next-Gen%20Virtual%20Gesture%20Touchpad%20for%20Windows&descColor=ff758c&descSize=20&descAlignY=70)" width="100%" alt="AeroGlide Animated Waving Title">
</p>

<!-- DYNAMIC TYPING SVG HEADER -->
<p align="center">
  <a href="https://github.com/idusha-manaka/AeroGlide">
    <img src="https://readme-typing-svg.herokuapp.com?font=Outfit&size=30&duration=2000&pause=800&color=00F0FF&center=true&vCenter=true&width=600&lines=🔮+THE+FUTURE+OF+DESKTOP+NAVIGATION;⚡+LOW-LEVEL+OS+INPUT+ACCELERATION;🌸+PREMIUM+CYBERPUNK+ANIME+HUD" alt="AeroGlide Title Animation" />
  </a>
</p>
...
<div style="background: #0c0d16; border: 2px solid #00F0FF; border-radius: 16px; padding: 25px; box-shadow: 0 8px 32px rgba(0, 240, 255, 0.15); margin: 30px 0;">
  ...
  <p align="center" style="margin: 25px 0;">
    <img src="assets/gestures_blueprint.svg" alt="AeroGlide Gesture Blueprint" width="100%" style="border-radius: 12px; border: 1.5px solid #FF007F; box-shadow: 0 10px 30px rgba(255, 0, 127, 0.25);">
  </p>
